...
class AuthenticationTests(APITestCase):
    ...
    def test_successful_registered_user(self):
        ...
        response = self.client.post(self.registration_url, self.user1, format='json')
    ...
    def test_unsuccessful_register_existing_user(self):
        ...
        self.client.post(self.registration_url, self.user1, format='json')
        response = self.client.post(self.registration_url, self.user1, format='json')
    ...
    def test_unsuccessful_register_without_user_name(self):
        ...
        self.user1['username'] = ""
        response1 = self.client.post(self.registration_url, self.user1, format='json')
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
